...
import 'package:school/entities/afazer_checklist_enty.dart';
        ...
        children: [
          Row(children: [
            ...
            DropdownButton(
              value: dropdownValue,
              items:const [
                DropdownMenuItem(value: TipoLista.lembrete, child: Text('Lembrete')),
                DropdownMenuItem(value: TipoLista.tarefa, child: Text('Tarefas')),
              ],
              onChanged: (value) {
                setState(() {
                  dropdownValue = value!;
          ...
          TextFormField(
            ...
            decoration: const InputDecoration(hintText: 'Digite um nome'), // Placeholder
            validator: (value) {
          ...
          if(dropdownValue == TipoLista.tarefa)
            ...
            Form(
              ...
              child: 
                Column(
                  children: itens.map((e) => defaultCheckItem(e)).toList(),
                ),
            ),
          const SpacerComponent(),
